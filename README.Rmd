...
O nome do pacote faz referência à página "Guia dos Musiqueiros" do Instagram :)
...
Se você quer usar as funções do guiamusicR pra se divertir um pouco no R, você precisa primeiro obter um token de acesso. Você pode conseguir isso [nessa página](https://www.spotify.com/br/account/overview/)
